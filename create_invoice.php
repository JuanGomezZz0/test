...
if (!empty($_POST['companyName']) && $_POST['companyName']) {
	...
	header("Location:invoice_list_admin.php");
}
?>
<link rel="icon" href="https://i.ibb.co/0BmgTXK/vision-limpieza-removebg-preview.png"><title>Sistema  de Facturación</title>
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<table class="table table-bordered table-hover" id="invoiceItem">
						...
						<tr>
							...
							<td><input min="0" type="text" name="productName[]" id="productName_1" class="form-control" autocomplete="off"></td>
							<td><input min="0" type="number" name="quantity[]" id="quantity_1" class="form-control quantity" autocomplete="off"></td>
